export const DropdownMenuClosedTickets = ({
  ...
  return (
    <ul className="w-[200px] shadow grid gap-[18px] dropdown-menu absolute bg-white p-[12px] text-black right-[25px] top-[40px] z-10">
      <li onClick={() => handleItemClick("Request Refund")} className="font-[400] cursor-pointer">
        Request Refund
      </li>
      <li onClick={() => handleItemClick("Vacate Table")} className="font-[400] cursor-pointer">
        Vacate Table
      </li>
      <li onClick={() => handleItemClick("Void Order")} className="font-[400] cursor-pointer">
        Void Order
      </li>
    </ul>
  );
