...
const InRoomDining: React.FC<InRoomDiningProps> = ({
  isGenerated,
  onOpenModal,
  onOpenEditModal,
  onOpenDeleteModal,
    ...
    return (
      <>
        ...
        <div className="flex flex-col items-center justify-center py-12">
          ...
          <button
            onClick={onOpenModal}
            className="bg-[#1D2939] text-white px-6 py-3 rounded-md"
          >
            Create QR Code
          </button>
        </div>
  ...
  return (
    <>
      {/* In-Room Dining Content - Generated QR */}
      ...
      <table className="w-full border-collapse">
        ...
        <tbody>
          ...
          <tr>
            <td className="px-4 py-3 text-sm text-[#1D2939]">103</td>
            <td className="px-4 py-3 text-sm text-[#1D2939]">3rd floor</td>
