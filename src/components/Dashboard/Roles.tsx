const Roles = () => {
  return (
    <div>
      <div className=" grid grid-cols-4 items-center border-b border-b-grey100 text-grey300 text-[16px]">
        <p className=" px-3 py-2">Role Name</p>
        <p className=" px-3 py-2">Description</p>
        <p className=" col-span-2 px-3 py-2"></p>
      </div>
      <div className=" grid grid-cols-4 items-center px-5 py-4  bg-[#F8F8F8] text-grey300 text-[16px] my-3">
